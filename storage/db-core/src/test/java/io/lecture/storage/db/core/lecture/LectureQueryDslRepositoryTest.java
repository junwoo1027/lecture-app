...
class LectureQueryDslRepositoryTest {
    ...
    // lectureQueryDslRepository.findPopularLectures(threeDaysAgo);
    //
    // // then
    // assertThat(result).hasSize(3);
    // assertThat(result).extracting("lecturer").containsOnly("준우");
    ...
    private void setCreatedAtForRegistration(int employeeNumber, long lectureId, LocalDateTime createdAt)
