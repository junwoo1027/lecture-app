...
public enum CoreErrorType {
    ...
    LECTURE_EXCEEDED(CoreErrorKind.SERVER_ERROR, CoreErrorCode.E1001, "Lecture has been exceeded.",
            CoreErrorLevel.INFO),
    ALREADY_APPLIED_LECTURE(CoreErrorKind.SERVER_ERROR, CoreErrorCode.E1002, "Already applied for a lecture.",
            CoreErrorLevel.INFO),
    NOT_VALID_EMPLOYEE_NUMBER(CoreErrorKind.SERVER_ERROR, CoreErrorCode.E1003, "Not valid employee number.",
            CoreErrorLevel.INFO);
